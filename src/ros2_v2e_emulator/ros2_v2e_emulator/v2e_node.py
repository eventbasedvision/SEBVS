#!/usr/bin/env python3
"""
ROS2 node wrapping the SensorsINI v2e emulator, with:
...
class V2ENode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("downsample",   1.0)    # no downsampling
        self.declare_parameter("blur",         False)  # no blur
